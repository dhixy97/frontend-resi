...
export default function ResiLabel({
  ...
  return (
    <div className="overflow-x-auto">
      <div className="p-4 border max-w-[600px] w-full mx-auto bg-white text-black">
        <div className="flex justify-between items-start mb-4 flex-wrap gap-2">
          <Image src="/main.png" alt="Logo" width={120} height={50} />
          <div className="text-right">
            <div className="text-xs font-bold text-black">[ NOMOR RESI PENGIRIMAN ]</div>
            <Barcode value={nomorResi} format="CODE128" height={50} displayValue={false} />
            <div className="text-base font-bold mt-2">{nomorResi}</div>
          </div>
        </div>
